...
public class FamilyClass {
	...
	{
	    double tempECost = ElectricityBill(Eunit);
	    double tempWCost = Wunit*3+(VatCalculation(Wunit));
	    final double gasBill = 800.00;
	    double tempMarketingCost = MarketCost(familyMember);
